...
window.Typekit.config = {
    "a": "568300",
    "c": [".tk-brandon-grotesque", "\"brandon-grotesque\",sans-serif", ".tk-lato", "\"lato\",sans-serif"],
    "dl": "AAAAuwAAAArnpU_MeB5myumd24v_6kpqDpzMEgfjBts",
    "f": "//use.typekit.net/c/b56d5f/1w;brandon-grotesque,2,Y2l:P:n4,Y2n:P:n5,Y2s:P:n9;lato,2,c0v:P:i5,c0r:P:n4,c0t:P:n5,c11:P:n9/{format}{/extras*}",
    "fc": [{
        "id": 10294,
        "family": "brandon-grotesque",
        "src": "{scheme}://{hostname}/af/9a0834/0000000000000000000132df/21/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 10302,
        "family": "brandon-grotesque",
        "src": "{scheme}://{hostname}/af/d306b8/0000000000000000000132e1/21/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "500",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 10304,
        "family": "brandon-grotesque",
        "src": "{scheme}://{hostname}/af/00e873/0000000000000000000132e5/21/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "900",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 15700,
        "family": "lato",
        "src": "{scheme}://{hostname}/af/616154/000000000000000000015235/21/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "900",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 15708,
        "family": "lato",
        "src": "{scheme}://{hostname}/af/dee704/00000000000000000001522c/21/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 22708,
        "family": "lato",
        "src": "{scheme}://{hostname}/af/6b2750/00000000000000000001522e/21/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "500",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 22709,
        "family": "lato",
        "src": "{scheme}://{hostname}/af/48271d/00000000000000000001522f/21/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "500",
            "style": "italic",
            "subset_id": 2
    ...
    "fi": [10294, 10302, 10304, 15700, 15708, 22708, 22709],
    "fn": ["brandon-grotesque", ["n4", "n5", "n9"], "lato", ["i5", "n4", "n5", "n9"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.18.13",
    "kt": "bmo5vxg",
    ...
    "p": "p.typekit.net",
    "ps": 1,
    "token": "",
    "type": "configurable"
};
...
(function(window, document, undefined) {
    ...
    function ma(a, b, c) {
        ...
        this.A = c.primer || void 0;
        this.B = c.subset_id || void 0
    }
    ...
    function ra(a, b, c, d) {
        for (var e = [], f = 0; f < b.length; f++) {
            ...
            "i" === g ? e.push("url(" + h + ")") : e.push("url(" + h + ') format("' + ta(g) + '")')
        }
        return e.join(",")
    }
    ...
    function ua(a, b, c, d, e) {
        if ("x" === b) return "";
        var f = [];
        f.push("font-family:" + (e ? E(a) : a.b));
        b = "k" === b ? ra(a, ["l", "d", "a"], c, d) : ra(a, [b], c, d);
        f.push("src:" + b);
        f.push("font-weight:" + a.weight);
        f.push("font-style:" + a.style);
        return "@font-face{" + f.join(";") + ";}"
    }
    ...
    function va(a, b, c, d, e, f, g, h) {
        ...
        this.F = h;
        this.w = f || null;
        this.i = new L(this.u, this.v);
        this.j = new L(this.u, this.v);
        this.m = new L(this.u, this.v);
        this.o = new L(this.u, this.v);
        a = this.F ? E(this.b) : this.b.b;
    ...
    function xa(a) {
        ...
        d ? m() - a.D >= a.H ? wa() && ya(a, b, c) && (!a.w || a.w.hasOwnProperty(a.b.b)) ? Q(a, a.C) : Q(a, a.G) : za(a) : Q(a, a.C)
    }
                ...
                if (null === S)
                    if (window.FontFace) {
                        var e = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent),
                            q = /OS X.*Version\/10\..*Safari/.exec(window.navigator.userAgent) && /Apple/.exec(window.navigator.vendor);
                        S = e ? 42 < parseInt(e[1], 10) : q ? !1 : !0
                    } else S = !1;
                S ? c = new Aa(k(a.i, a), k(a.j, a), a.v, b, a.w, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006",
                    a.u) : c = new va(k(a.i, a), k(a.j, a), a.v, b, a.w, d, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u);
                f.push(c)
            });
            ...
            active: function() {
                ...
                if (d.v) {
                    var a = d.v,
                        ...
                        h = (window.__adobewebfontsappname__ || a.app || "").toString().substr(0, 20),
                        b = b.g.location.hostname || b.i.location.hostname,
                        l = [],
                        w = [];
                    window.Typekit ? (window.Typekit.fonts || (window.Typekit.fonts = []), w = window.Typekit.fonts) : window.TypekitPreview &&
                        (window.TypekitPreview.fonts || (window.TypekitPreview.fonts = []), w = window.TypekitPreview.fonts);
        ...
        if (this.j) {
            ...
            if (!this.j.has(h)) {
                console.error('Typekit: the domain "' +
                    h + '" isn\'t in the list of published domains for kit "' + this.u + '".');
                B(c);
                return
            }
        }
        if (g.b.length) {
            h = K(g, f, this.m, this.i, e);
            A(this.b, h);
            var l = new R(this.b, c, a, e);
            ia(d.b, function() {
                Ba(l, g, b)
            })
        } else B(c)
    ...
    if (!window.Typekit.load) {
        var V = new U(new G("//" + (window.Typekit.config || {}).hn + "/{id}.js"), Ga);
    ...
    if (n.fc)
        for (var X = n.fc, Z = 0; Z < X.length; Z++) W.o.b.push(new ma(X[Z].family, X[Z].src, X[Z].descriptors));
    if (n.dl) {
        var Ha = n.dl;
        try {
            W.j = new ha(Ha)
    ...
    n.token && (W.i = n.token);
    if (n.c)
        for (var p = 0; p < n.c.length; p += 2) W.g.push(new da);
    window.Typekit.addKit(W);
    if (1 === Math.round(30 * Math.random())) {
        var Ia = window.Typekit.load,
            Ja = [];
        window.Typekit.load = function(a) {
            ...
            a.fontactive = function(a, b) {
                ...
                c(a, b);
                a: {
                    g = b.charAt(0);h = b.charAt(1);
                    /[1-9]/.test(h) || (h = 4);g = "i" === g ? "italic" : "o" === g ? "oblique" : "normal";h += "00";
                    for (var l = n.fc, q = 0; q < l.length; q++)
                        if (l[q].family === a && l[q].descriptors.weight === h && l[q].descriptors.style === g) {
                            g = l[q].id;
                            break a
                        }
                    g = 0
